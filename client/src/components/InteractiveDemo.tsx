...
const generatePlatformPosts = (
  businessDescription: string,
  brandStyles: string = "professional",
): PlatformPost[] => {
  ...
  return platforms.map((platform) => ({
    ...
    caption: generatePlatformCaption(
      campaignIdea,
      businessType,
      platform.tone,
      businessDescription,
...
const generatePlatformCaption = (
  campaignIdea: string,
  businessType: string,
  tone: string,
  businessDescription: string = "",
  brandStyle: string = "professional",
): string => {
  ...
  if (desc.includes("art history") && desc.includes("teacher")) {
    if (tone === "professional")
      return `Transform your understanding of art history with ${campaignIdea}. From Renaissance masters to contemporary movements, explore the stories that shaped our visual culture. Join art enthusiasts who value deep, scholarly insight.`;
    if (tone === "casual-engaging")
      return `${campaignIdea} From Monet's water lilies to Picasso's revolutionary cubism - art history has never been this engaging! Who else loves discovering the stories behind masterpieces? #ArtHistory #Monet #Picasso`;
    if (tone === "friendly-detailed")
      return `Hello art lovers! I'm excited to offer ${campaignIdea} to fellow enthusiasts of visual culture! Whether you're fascinated by the mysteries of ancient Egyptian art or the bold innovations of modern expressionism, let's explore art history together. Each lesson brings masterpieces to life with context, meaning, and cultural significance!`;
  ...
  if (
    ...
    desc.includes("counseling") ||
    desc.includes("therapy")
  ) {
    if (tone === "professional")
      return `Experience compassionate, evidence-based therapy with ${campaignIdea}. In a safe, confidential environment, we work together toward healing, growth, and emotional wellness. Join individuals who prioritize their mental health journey.`;
    if (tone === "friendly-detailed")
      return `Dear friends seeking wellness. I'm honored to offer ${campaignIdea} to support your journey toward emotional health and personal growth. Therapy is a brave step, and you don't have to walk this path alone. Together, we'll work at your pace in a judgment-free space where healing begins.`;
    if (tone === "conversational")
      return `Taking care of your mental health is one of the bravest things you can do. ${campaignIdea} offers a safe space to process, heal, and grow. Anyone else believe therapy should be accessible and stigma-free?`;
  ...
  if (desc.includes("photographer") && desc.includes("wedding")) {
    if (tone === "professional")
      return `Preserve your most precious moments with ${campaignIdea}. Specializing in timeless wedding photography that captures the authentic emotions, intimate details, and pure joy of your celebration. Trusted by couples who value artistry and excellence.`;
    if (tone === "friendly-detailed")
      return `Beautiful couples! I'm thrilled to announce ${campaignIdea} for engagements and weddings! Your love story deserves to be told through stunning imagery that captures every laugh, every tear, and every magical moment. From getting-ready shots to your first dance, let's create heirloom images you'll treasure forever!`;
    if (tone === "casual-engaging")
      return `${campaignIdea} Because your love story deserves to be captured beautifully! From the nervous excitement of getting ready to that perfect kiss at the altar - every moment is precious. Tag your person! #WeddingPhotography #LoveStory`;
  ...
  const businessKey = ["restaurant", "fitness", "beauty"].includes(businessType)
    ? businessType
    : "default";
  return (
    captions[tone]?.[businessKey] || `${campaignIdea} - Limited time offer!`
  );
};
...
const getSmartVisual = (
  ...
  const getBusinessContextualImage = (): string => {
    ...
    if (
      desc.includes("botox") ||
      desc.includes("dermal") ||
      desc.includes("filler") ||
    ...
    // BEAUTY SALONS
    if (
      desc.includes("beauty salon") ||
      desc.includes("hair salon") ||
      desc.includes("salon")
    ) {
      const salonImages = [
    ...
    // COFFEE SHOPS & CAFES
    if (
      desc.includes("coffee shop") ||
      desc.includes("coffee") ||
      desc.includes("cafe") ||
      desc.includes("coffeehouse") ||
      desc.includes("espresso") ||
      desc.includes("barista")
    ) {
      const coffeeImages = [
    ...
    // FOOD TRUCKS
    if (
      desc.includes("food truck") ||
      desc.includes("food cart") ||
      desc.includes("mobile food")
    ) {
    ...
    if (
      ...
      desc.includes("panadería") ||
      desc.includes("pastelería") ||
      desc.includes("repostería") ||
      desc.includes("pasteles") ||
      desc.includes("postres") ||
      desc.includes("cakes") ||
      desc.includes("cupcakes")
    ) {
      const bakeryImages = [
    ...
    if (
      ...
      desc.includes("personal training")
    ) {
      const fitnessImages = [
    ...
    if (
      desc.includes("yoga") ||
      desc.includes("yoga studio") ||
      desc.includes("meditation") ||
      desc.includes("mindfulness")
    ) {
      const yogaImages = [
    ...
    if (
      ...
      desc.includes("jewellery") ||
      desc.includes("joyería") ||
      desc.includes("joyas") ||
      desc.includes("anillos") ||
      desc.includes("rings") ||
      desc.includes("collares") ||
      desc.includes("necklaces") ||
      desc.includes("diamantes") ||
    ...
    if (
      ...
      desc.includes("clothing boutique")
    ) {
      const boutiquImages = [
    ...
    // GIFT SHOPS
    if (
      desc.includes("gift shop") ||
      desc.includes("gift store") ||
      desc.includes("souvenirs")
    ) {
      const giftImages = [
    ...
    // TOY STORES
    if (
      desc.includes("toy store") ||
      desc.includes("toys") ||
      desc.includes("children") ||
      desc.includes("kids store")
    ) {
      const toyImages = [
    ...
    if (
      ...
      desc.includes("electronics store") ||
      desc.includes("tech store") ||
      desc.includes("gadgets")
    ) {
    ...
    if (
      ...
      desc.includes("furniture store") ||
      desc.includes("home decor")
    ) {
    ...
    if (
      ...
      desc.includes("florist") ||
      desc.includes("floristería") ||
      desc.includes("flores") ||
      desc.includes("arreglos") ||
      desc.includes("bouquet") ||
      desc.includes("wedding flowers")
    ) {
      const floristImages = [
    ...
    if (
      ...
      desc.includes("barbershop") ||
      desc.includes("barbería") ||
      desc.includes("peluquería") ||
      desc.includes("hair salon") ||
    ...
    if (
      ...
      desc.includes("librería") ||
      desc.includes("libros") ||
      desc.includes("books")
    ) {
    ...
    // PET SHOPS
    if (
      desc.includes("pet shop") ||
      desc.includes("pet store") ||
      desc.includes("pets") ||
      desc.includes("mascotas")
    ) {
      const petShopImages = [
    ...
    if (
      desc.includes("vet") ||
      desc.includes("veterinary") ||
      desc.includes("veterinary clinic") ||
      desc.includes("animal hospital")
    ) {
      const vetImages = [
    ...
    // AUTO REPAIR SHOPS
    if (
      desc.includes("auto repair") ||
      desc.includes("car repair") ||
      desc.includes("mechanic") ||
      desc.includes("automotive repair")
    ) {
    ...
    // DESIGN STUDIOS
    if (
      desc.includes("interior design") ||
      desc.includes("design studio") ||
      desc.includes("interior designer")
    ) {
    ...
    if (
      ...
      desc.includes("architecture firm")
    ) {
    ...
    if (
      ...
      desc.includes("cleaning service") ||
      desc.includes("housekeeping")
    ) {
    ...
    if (
      ...
      desc.includes("gardening") ||
      desc.includes("lawn care")
    ) {
    ...
    if (
      ...
      desc.includes("marketing agency") ||
    ...
    // TATTOO STUDIOS
    if (
      desc.includes("tattoo") ||
      desc.includes("tattoo studio") ||
      desc.includes("tattoo parlor")
    ) {
      const tattooImages = [
    ...
    if (
      desc.includes("tutoring") ||
      desc.includes("education center") ||
      desc.includes("learning center")
    ) {
...
const getIndustryVariedImage = (
  ...
  if (
    desc.includes("botox clinic") ||
    desc.includes("aesthetic clinic") ||
    desc.includes("cosmetic clinic") ||
    desc.includes("med spa") ||
    desc.includes("medical spa")
  ) {
  ...
  if (
    desc.includes("wedding photographer") ||
    desc.includes("wedding photography")
  ) {
    ...
    return weddingPhotographyImages[
      postIndex % weddingPhotographyImages.length
    ];
  }
  ...
  if (
    desc.includes("italian restaurant") ||
    desc.includes("italian pizzeria") ||
    desc.includes("italian cuisine")
  ) {
  ...
  if (
    desc.includes("personal trainer") ||
    desc.includes("fitness trainer") ||
    desc.includes("fitness coach")
  ) {
  ...
  if (
    desc.includes("artisan bakery") ||
    desc.includes("sourdough bakery") ||
    desc.includes("local bakery")
  ) {
...
const getTikTokOverlayText = (
  ...
  if (desc.includes("jewelry") || desc.includes("joyería")) {
    const tikTokTexts = [
      ...
      isSpanish
        ? "#DiseñoPersonalizado #Exclusivo"
        : "#CustomDesign #Exclusive",
    ];
    return tikTokTexts[Math.floor(postIndex / 2)] || tikTokTexts[0];
  }
  ...
  if (
    ...
    const tikTokTexts = [
      isSpanish
        ? "#BellezaNatural #Transformación"
        : "#NaturalBeauty #Transformation",
  ...
  if (desc.includes("restaurant") || desc.includes("food")) {
    const tikTokTexts = [
      isSpanish
        ? "#ComidaDeliciosa #RestauranteLocal"
        : "#DeliciousFood #LocalRestaurant",
      isSpanish
        ? "#ChefEspecial #SaboresUnicos"
        : "#ChefSpecial #UniqueFlavors",
      isSpanish
        ? "#ExperienciaGastronomica #Foodie"
        : "#DiningExperience #Foodie",
    ];
    return tikTokTexts[Math.floor(postIndex / 2)] || tikTokTexts[0];
  }
  ...
  const defaultTexts = [
    ...
    isSpanish
      ? "#ServicioProfesional #Excelencia"
      : "#ProfessionalService #Excellence",
...
const detectBusinessType = (description: string): string => {
  ...
  if (
    ...
    desc.includes("business services")
  ) {
  ...
  if (
    ...
    desc.includes("home repair") ||
    desc.includes("handyman")
  ) {
  ...
  if (
    ...
    desc.includes("photography") ||
    desc.includes("videography")
  ) {
  ...
  if (
    desc.includes("non-profit") ||
    desc.includes("nonprofit") ||
  ...
  if (
    ...
    desc.includes("farming") ||
    desc.includes("organic") ||
    desc.includes("crops") ||
  ...
  if (
    ...
    desc.includes("gallery") ||
    desc.includes("studio") ||
    desc.includes("crafts")
  ) {
...
const generateCampaignIdea = (
  ...
  if (
    desc.includes("italian") &&
    (desc.includes("pasta") || desc.includes("restaurant"))
  ) {
...
export function InteractiveDemo({ isSpanish }: InteractiveDemoProps) {
  ...
  const [selectedBrandStyles, setSelectedBrandStyles] = useState<string[]>([
    "professional",
  ]);
  ...
  const handleGenerateCampaign = async () => {
    ...
    const posts = generatePlatformPosts(
      ...
      selectedBrandStyles.join(","),
    );
    const businessType = detectBusinessType(demo.businessDescription);
    const campaignIdea = generateCampaignIdea(
      demo.businessDescription,
      businessType,
    );
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-4">
            <span className="bg-gradient-to-r from-orange-600 via-amber-600 to-orange-800 bg-clip-text text-transparent">
              {isSpanish
                ? "PRUEBA NUESTRO DEMO GRATIS AHORA"
                : "TRY FREE DEMO NOW"}
            </span>
          </h3>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <option value="Beauty & Wellness">
                  {isSpanish ? "Belleza y Bienestar" : "Beauty & Wellness"}
                </option>
                <option value="Fitness & Health">
                  {isSpanish ? "Fitness y Salud" : "Fitness & Health"}
                </option>
                <option value="Retail & Fashion">
                  {isSpanish ? "Venta y Moda" : "Retail & Fashion"}
                </option>
                ...
                <option value="Real Estate">
                  {isSpanish ? "Bienes Raíces" : "Real Estate"}
                </option>
                ...
                <option value="Healthcare & Medical">
                  {isSpanish ? "Salud y Médico" : "Healthcare & Medical"}
                </option>
                <option value="Automotive">
                  {isSpanish ? "Automotriz" : "Automotive"}
                </option>
                <option value="Home Services">
                  {isSpanish ? "Servicios para el Hogar" : "Home Services"}
                </option>
                ...
                <option value="Travel & Tourism">
                  {isSpanish ? "Viajes y Turismo" : "Travel & Tourism"}
                </option>
                <option value="Non-Profit & Community">
                  {isSpanish
                    ? "Sin Fines de Lucro y Comunidad"
                    : "Non-Profit & Community"}
                </option>
                <option value="Financial Services">
                  {isSpanish ? "Servicios Financieros" : "Financial Services"}
                </option>
                <option value="E-commerce & Online Business">
                  {isSpanish
                    ? "E-commerce y Negocios Online"
                    : "E-commerce & Online Business"}
                </option>
                ...
                <option value="Arts & Creative Services">
                  {isSpanish
                    ? "Artes y Servicios Creativos"
                    : "Arts & Creative Services"}
                </option>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <Input
                    placeholder={
                      isSpanish ? "www.tu-sitio.com" : "www.yoursite.com"
                    }
    ...
    <div className="space-y-16">
      ...
      <div className="text-center max-w-4xl mx-auto">
        ...
        <div className="bg-white border border-neutral-200/70 rounded-2xl p-8 mb-8">
          ...
          <p className="text-sm text-neutral-500 mt-2">
            {isSpanish
              ? "Optimizada para 8 plataformas populares"
              : "Optimized for 8 popular platforms"}
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {platformPosts.map((post, index) => (
          <Card
            key={index}
            className="overflow-hidden bg-white border border-neutral-200/70 rounded-2xl hover:shadow-md transition-all duration-200 ease-out cursor-pointer"
          ...
          >
            ...
            <CardContent className="pt-0">
              {/* Clean Visual Design */}
              <div
                className={`relative mb-4 rounded-xl overflow-hidden transition-all duration-200 ${
                  post.aspectRatio === "story"
                    ? "aspect-[9/16] max-h-40"
                    : post.aspectRatio === "banner"
                      ? "aspect-[3/1]"
            ...
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-neutral-100">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">
                  {isSpanish ? "30 días planificados" : "30 days planned"}
                </p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-0.5">
              {Array.from({ length: 9 }, (_, index) => {
                ...
                if (
                  ...
                  index < demo.uploadedImages.length
                ) {
                  ...
                  imageUrl = getIndustryVariedImage(
                    demo.businessDescription,
                    businessType,
                    index,
                  );
          ...
          <div className="bg-neutral-900 rounded-2xl border border-neutral-700 p-6">
            ...
            <div className="grid grid-cols-3 gap-1">
              {Array.from({ length: 6 }, (_, index) => {
                ...
                const tikTokText = getTikTokOverlayText(
                  demo.businessDescription,
                  businessType,
                  index,
                  generatedCampaign,
                ...
                return (
                  <div
                    key={index}
                    className="aspect-[9/16] relative group cursor-pointer bg-gray-900 rounded-lg overflow-hidden"
                  >
                    <img
                      src={imageUrl}
                      alt={`TikTok ${index + 1}`}
          ...
          <div className="bg-white rounded-2xl border border-neutral-200/70 p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={platform.name}
                  className="bg-neutral-50 rounded-xl p-4 text-center border border-neutral-200/50 hover:bg-neutral-100 transition-colors duration-200"
                >
      ...
      <div className="text-center max-w-md mx-auto">
        ...
        >
          <span>
            {isSpanish ? "Publicar en Todas Partes" : "Post Everywhere"}
          </span>
      ...
      <div className="text-center mt-12 pt-8 border-t">
        ...
        <div className="bg-gradient-to-r from-brand-50 to-brand-100 rounded-xl p-6 mb-6">
          <h4 className="text-lg font-bold text-gray-900 mb-2">
            {isSpanish
              ? "¿Quieres VERDADERO contenido IA personalizado?"
              : "Want REAL AI-personalized content?"}
          </h4>
        ...
        <div className="mt-12 text-center">
          <h4 className="text-xl font-bold text-gray-900 mb-4">
            {isSpanish
              ? "🎥 Ve CampAIgner Enterprise en Acción"
              : "🎥 See CampAIgner Enterprise in Action"}
          </h4>
            ...
            <div className="aspect-video relative bg-gray-900 flex items-center justify-center">
              ...
              <div className="relative z-10 text-center text-white">
                ...
                <h5 className="text-xl font-bold mb-2">
                  {isSpanish
                    ? "Demo Enterprise: Restaurant Tony's"
                    : "Enterprise Demo: Tony's Restaurant"}
                </h5>
                <p className="text-white/80 text-sm">
                  {isSpanish
                    ? "3:24 min • Ver cómo genera 21 campañas desde datos POS"
                    : "3:24 min • Watch how it generates 21 campaigns from POS data"}
                </p>
              </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {isSpanish
                        ? "Propietario, Tony's Italian Kitchen"
                        : "Owner, Tony's Italian Kitchen"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    {![
                      ...
                      "Twitter/X Post",
                      "Facebook Post",
                    ].includes(selectedPost.platform) && (
