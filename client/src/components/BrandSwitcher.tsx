...
import { ChevronDown, Building2, Globe, Crown, Shield, Edit, Eye } from "lucide-react";
...
export default function BrandSwitcher() {
  ...
  const { activeBrandId, activeMembership, memberships, isLoading, switchBrand } = useBrand();
      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          <Avatar className="h-6 w-6 mr-2">
            <AvatarFallback 
              style={{ backgroundColor: activeMembership?.brandColor || '#3f82d1' }}
