...
export const translations = {
  en: {
    ...
    // Landing
    landing: {
      waterfallTitle: "Meet CampAIgner",
      ...
      heroSubtitle: "Meet CampAIgner takes your single campaign idea and instantly creates optimized content for Instagram, TikTok, Facebook, WhatsApp, LinkedIn, YouTube and 16+ more platforms — all in the correct format and size.",
      oneIdea: "ONE IDEA",
      everywhere: "EVERYWHERE",
      instantly: "INSTANTLY",
      waterfallDemo: "Try CampAIgner",
      getStarted: "Start CampAIgner",
    ...
    dashboard: {
      ...
      createWaterfallCampaign: "CampAIgner",
  ...
  es: {
    ...
    // Landing
    landing: {
      waterfallTitle: "Conoce CampAIgner",
      ...
      heroSubtitle: "Conoce CampAIgner toma tu idea de campaña y crea instantáneamente contenido optimizado para Instagram, TikTok, Facebook, WhatsApp, LinkedIn, YouTube y 16+ plataformas más — todo en el formato y tamaño correcto.",
      oneIdea: "UNA IDEA",
      everywhere: "TODOS LADOS",
      instantly: "INSTANTÁNEO",
      waterfallDemo: "Prueba CampAIgner",
      getStarted: "Inicia CampAIgner",
