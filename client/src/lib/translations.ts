...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      freeTrialTitle: "Try Starter or Professional Plans Free for 30 Days",
      freeTrialDesc: "No credit card required for Starter and Professional plans. Cancel anytime. Experience the full power of our platform.",
