              ...
              <div className="bg-blue-50 p-6 rounded-xl mb-6 border border-blue-100">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    <span>5 Brands</span>
                    <span className="font-medium text-gray-900">$199/mo</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>10 Brands</span>
                    <span className="font-medium text-gray-900">$349/mo</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>20 Brands</span>
                    <span className="font-medium text-gray-900">$599/mo</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>50+ Brands</span>
                    <span className="font-medium text-gray-900">$999/mo</span>
                  </div>
                </div>
              </div>
