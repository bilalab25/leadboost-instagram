...
export default function Inbox() {
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (data: {
      ...
      const conversationIdForMessages =
        data.dbConversationId || data.conversationId;
        ...
        <div className="flex flex-col w-0 flex-1 overflow-hidden">
          <main className="flex-1 relative overflow-y-auto focus:outline-none">
            <Tabs
              value={activeTab}
              onValueChange={(value) =>
                setActiveTab(value as "inbox" | "flows")
              }
              className="w-full h-full flex flex-col"
            >
              <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-8 pt-4">
                  ...
                  >
                    <TabsTrigger
                      ...
                      className={cn(
                        ...
                        "data-[state=active]:bg-gradient-to-r data-[state=active]:from-brand-600 data-[state=active]:to-cyan-500",
                      )}
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        {" "}
                        {isSpanish ? "Buzón de mensajes" : "Inbox  "}
                      </span>{" "}
                    </TabsTrigger>
                    <TabsTrigger
                      value="flows"
                            ...
                            <CardContent className="p-4">
                              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                ...
                                <div className="flex items-center flex-wrap gap-2">
                                  <Button
                                    variant={
                                      !selectedPlatform ? "default" : "outline"
                                    }
                                    size="sm"
                                    onClick={() =>
                                      handlePlatformSelect(undefined)
                                    }
                                    className={cn(
                                      "rounded-full",
                                      !selectedPlatform &&
