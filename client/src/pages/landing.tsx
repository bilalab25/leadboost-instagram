        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-500">
              ...
              <p className="text-gray-600 mb-4">
                {isSpanish 
                  ? 'Creación completa de contenido mensual generado por IA basado en la data de tu POS'
                  : 'Complete monthly content creation generated by AI based on your POS data'}
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
