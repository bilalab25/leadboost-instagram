      ...
      <div className="py-24 bg-gradient-to-br from-brand-200/50 via-brand-300/40 to-brand-200/60 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Unified Inbox */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-blue-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
            ...
            {/* AI Content Planner */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
            ...
            {/* Advanced Analytics */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-green-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
            ...
            {/* Team Collaboration */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-orange-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
            ...
            {/* Campaign Management */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-red-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
            ...
            {/* Global Reach */}
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-teal-500 bg-gradient-to-br from-brand-50 to-brand-100">
              <div className="flex items-center mb-4">
