          ...
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
                {isSpanish 
                  ? 'Transforma los datos de tu negocio en campañas completas del sistema waterfall para 21+ plataformas — todo en un clic.'
                  : 'Transform your business data into complete waterfall system campaigns across 21+ platforms — all in one click.'}
              </p>
            </div>
          </div>
        </div>
