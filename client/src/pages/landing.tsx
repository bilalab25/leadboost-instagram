          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-500">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">
                  {isSpanish ? 'Planificador IA' : 'AI Planner'}
                </h3>
              </div>
              <p className="text-gray-600 mb-4">
                {isSpanish 
                  ? 'Estrategias de contenido mensuales generadas por IA basadas en tu negocio'
                  : 'Monthly content strategies generated by AI based on your business'}
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
