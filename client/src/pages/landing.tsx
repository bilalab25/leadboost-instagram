  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute top-32 right-8 lg:right-16 z-20">
        <div className="group bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-lg shadow-sm p-7 w-80 hover:shadow-md transition-all duration-200 animate-cascade-fall" style={{ animationDelay: '1.5s' }}>
      ...
      <div className="absolute top-72 right-8 lg:right-16 z-20">
        <div className="group bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-lg shadow-sm p-7 w-80 hover:shadow-md transition-all duration-200 animate-cascade-fall" style={{ animationDelay: '3.2s' }}>
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-gradient-to-r from-brand-500 to-brand-700 rounded-full flex items-center justify-center flex-shrink-0">
      ...
      <div className="absolute top-[28rem] right-8 lg:right-16 z-20">
        <div className="group bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-lg shadow-sm p-7 w-80 hover:shadow-md transition-all duration-200 animate-cascade-fall" style={{ animationDelay: '4.9s' }}>
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-gradient-to-r from-brand-500 to-brand-700 rounded-full flex items-center justify-center flex-shrink-0">
