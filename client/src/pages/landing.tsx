                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-80 bg-white/95 backdrop-blur-md border border-gray-200 shadow-xl rounded-2xl p-2">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-gray-900 mb-1">{isSpanish ? 'Hub de Clientes' : 'Customer Hub'}</div>
                        <div className="text-sm text-gray-600 leading-relaxed">
                          {isSpanish ? 'Inbox unificado con perfiles automáticos de clientes, historial de compras y archivos digitales adjuntos' : 'Unified inbox with automatic customer profiles, purchase history and digital file attachments'}
                        </div>
                      </div>
                    </DropdownMenuItem>
