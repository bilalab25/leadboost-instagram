        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <Card className="text-center p-6 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 bg-white/90 backdrop-blur-sm border border-green-100 hover:border-green-200 hover-lift">
                <CardContent className="pt-6">
                  <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-4 transform hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/30 animate-float">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-500">
              ...
              <ul className="text-sm text-gray-500 space-y-2">
                <li>• {isSpanish ? 'Contenido respaldado por tu POS' : 'Content backed from your POS'}</li>
