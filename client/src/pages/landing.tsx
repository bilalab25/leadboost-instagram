    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-brand-100">
          ...
          <div className="flex justify-between items-center py-1">
            <div className="flex items-center space-x-3">
              <img 
                src={leadBoostLogo} 
                alt="LeadBoost Logo" 
                className="h-[305px] w-auto object-contain"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600">
                    {isSpanish 
                      ? 'Maximiza tu alcance sin el trabajo multiplicado por 30.'
                      : 'Maximize your reach without 30x the work.'}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-blue-500">
              ...
              <ul className="text-sm text-gray-500 space-y-2">
                ...
                <li>• {isSpanish ? 'Priorización inteligente' : 'Smart prioritization'}</li>
              </ul>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-purple-500">
              ...
              <p className="text-gray-600 mb-4">
                {isSpanish 
                  ? 'Creación completa de contenido mensual generado por IA basado en tu industria y/o data de tu POS'
                  : 'Complete monthly content creation generated by AI based on your industry and/or POS data'}
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
                <li>• {isSpanish ? 'Calendarios personalizados' : 'Custom calendars'}</li>
                <li>• {isSpanish ? 'Hashtags optimizados' : 'Optimized hashtags'}</li>
                <li>• {isSpanish ? 'Ideas de contenido viral' : 'Viral content ideas'}</li>
              </ul>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-green-500">
              ...
              <ul className="text-sm text-gray-500 space-y-2">
                ...
                <li>• {isSpanish ? 'Engagement en tiempo real' : 'Real-time engagement'}</li>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-l-4 border-l-red-500">
              ...
              <ul className="text-sm text-gray-500 space-y-2">
                ...
                <li>• {isSpanish ? 'Optimización en tiempo real' : 'Real-time optimization'}</li>
              </ul>
            </Card>
      ...
      <div className="py-20 bg-gradient-to-r from-brand-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button 
            size="lg" 
            className="bg-white text-brand-600 hover:bg-gray-100 px-12 py-4 text-xl font-bold shadow-xl transform hover:scale-105 transition-all duration-300 rounded-2xl"
          >
