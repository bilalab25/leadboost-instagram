  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-brand-50 via-brand-25 to-brand-100 relative overflow-hidden">
        ...
        {/* Final CTA */}
        <div className="py-24 bg-gradient-to-br from-brand-800 via-brand-700 to-brand-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-6">
                {isSpanish ? 'LeadBoost, donde el marketing empieza a funcionar.' : 'LeadBoost, where marketing starts working.'}
              </p>
