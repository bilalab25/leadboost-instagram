        ...
        <div className="relative overflow-hidden mt-0 min-h-screen bg-gray-50">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 pt-56 pb-24 lg:pt-64 lg:pb-32">
            <div className="max-w-4xl">
              <h1 className="text-6xl lg:text-8xl xl:text-9xl font-bold bg-gradient-to-r from-brand-800 via-brand-700 to-brand-900 bg-clip-text text-transparent mb-12 leading-[0.9] tracking-[-0.02em] drop-shadow-lg filter brightness-110 relative z-10">
