...
export default function Landing() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-brand-25 to-brand-100 relative overflow-hidden">
      ...
      {/* CampAIgner Hero Section - THE CENTERPIECE */}
          ...
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
                {isSpanish 
                  ? 'Nuestra app transforma los datos de tu negocio en campañas poderosas, perfectamente dimensionadas para 21+ plataformas — todo en un clic.'
                  : 'Our app transforms your business data into powerful campaigns, perfectly sized for 21+ platforms — all in one click.'}
              </p>
            </div>
          </div>
        </div>
