  ...
  const handleCreateCampaign = () => {
    if (
      ...
      toast({
        title: "Error",
        description:
          "Please fill in all required fields and select at least one platform",
        variant: "destructive",
      });
      return;
    }
            ...
            <div className="flex justify-end items-center space-x-4">
              <Dialog open={isAIDialogOpen} onOpenChange={setIsAIDialogOpen}>
                <DialogTrigger asChild>
                  <Button
                    variant="outline"
                    className="bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200 text-amber-700 hover:from-amber-100 hover:to-yellow-100 font-medium shadow-sm"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg">
                        <p className="text-xs text-gray-600 mb-3">
                          {t.campaigns.platformsHint}
                        </p>
                        <div className="grid grid-cols-2 gap-2">
                          {(isSpanish
                            ? platformOptionsSpanish
                            : platformOptions
                          ).map((platform) => {
                            const originalPlatform = platformOptions.find(
                        ...
                        {platformOptions.map((platform) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <Icon
                                  className={cn("mr-2 h-4 w-4", platform.color)}
                                />
                                {platform.label}
                              </Label>
                            </div>
                  ...
                  <CardContent className="p-4 text-center">
                    <div className="flex items-center justify-center mb-1">
                      ...
                      <div
                        ...
                        data-testid="stat-scheduled-campaigns"
                      >
                  ...
                  <CardContent className="p-4 text-center">
                    <div className="flex items-center justify-center mb-1">
                      ...
                      <div
                        ...
                        data-testid="stat-published-campaigns"
                      >
                                ...
                                <div className="grid grid-cols-3 gap-2 text-center">
                                  <div>
                                    <p
                                      ...
                                      data-testid={`campaign-reach-${campaign.id}`}
                                    >
                                      {(
                                  ...
                                  <div>
                                    <p
                                      className="text-sm font-medium"
                                      data-testid={`campaign-engagement-${campaign.id}`}
                                    >
                                  ...
                                  <div>
                                    <p
                                      className="text-sm font-medium"
                                      data-testid={`campaign-clicks-${campaign.id}`}
                                    >
                    ...
                    <Card className="text-center py-12">
                      <CardContent>
                        ...
                        <h3
                          ...
                          data-testid="text-no-campaigns"
                        >
                          No campaigns yet
                        </h3>
                        <p className="text-gray-600 mb-4">
                          Create your first campaign to start engaging with your
                          audience.
                        </p>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center pt-2">
                                  ...
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    data-testid={`button-filtered-view-${campaign.id}`}
                                  >
                                    View Details
                                  </Button>
                                </div>
                        ...
                        <Card className="text-center py-12 col-span-full">
                          <CardContent>
                            <p
                              ...
                              data-testid={`text-no-${status}-campaigns`}
                            >
                              No {status === "ai" ? "AI generated" : status}{" "}
                              campaigns found.
                            </p>
                          </CardContent>
                        </Card>
